    ...
    <div className="w-full  pt-36">
      ...
      <div className="relative w-full h-[300px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 text-white">
          <h1 className="text-5xl font-bold relative -top-[20px]">
            Our <span className="text-[#8DC63E]">Services</span>
          </h1>
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
            <Link to="/training" className="px-4 py-2 text-white rounded font-bold">
              Home &gt; <span className="text-[#8DC63E]">Services</span>
            </Link>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex border-b border-[#8DC63E] mb-4">
          {[
            { id: "training", label: "Dispute Resolution Platform" },
            { id: "cert", label: "Technical Auditing Request System" },
          ].map((tab) => (
            <button
              key={tab.id}
